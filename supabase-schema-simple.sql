...
-- VERSION SIMPLIFIÉE SANS RLS D'ABORD
-- ============================================

CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- ============================================
-- TABLES SEULEMENT (SANS RLS POUR COMMENCER)
-- ============================================
...
-- ============================================
/*
CE SCRIPT CRÉE LES TABLES SANS RLS.
VOUS POUVEZ AJOUTER LES RLS POLICIES MANUELLEMENT DEPUIS L'INTERFACE SUPABASE :

1. Aller dans Authentication > Policies
2. Cliquer sur chaque table
3. Activer RLS
4. Ajouter les policies via l'interface graphique

OU utiliser le code API qui gère déjà la sécurité via SUPABASE_SERVICE_ROLE_KEY.
*/
